...
[AddComponentMenu("Formie Engine/Objects/Goal Plate")]
public class GoalPlate : FormieObject
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.CompareTag("Player") && !activated)
        {
            ...
            //ScoreManager.Instance.BitBonus += ScoreManager.Instance.Bits * 100;
            ...
            //bonusScore = ScoreManager.Instance.Score + ScoreManager.Instance.BitBonus + ScoreManager.Instance.TimeBonus;
    ...
    //    LeanTween.value(ScoreManager.Instance.BitBonus, 0, 1).setOnUpdate((float val) =>
    //    {
    //        ScoreManager.Instance.bitsBonusCounter.text = ((int)val).ToString();
    //    });
